...
<span style="padding-top: 30px; width: 50%;">
	<h2>Add Products</h2> 
	<form:form commandName="product" method="POST"  action="${pageContext.servletContext.contextPath}/admin/addProducts"  onSubmit="return Validate();" 	enctype="multipart/form-data"  >
		<table>
			<tr>
				<td>
					<table>
						<tr>
							<td><form:label class="label-Font" path="name">Name<font
										color="red">*</font>
								</form:label></td>
							<td><form:input path="name" id="txtname" class="text-box"
									placeholder="Product Name" />
									<form:input type="hidden" path="id" id="txtid" class="text-box" />
									</td>
						</tr>
						<tr>
							<td><form:label class="label-Font" path="productCode">Product Code<font
										color="red">*</font>
								</form:label></td>
							<td><form:input path="productCode" id="txtemail"
									class="text-box" placeholder="SKU Product Code" /></td>
						</tr>
						<tr>
							<td><form:label class="label-Font" path="productTag">Product TagLine<font
										color="red">*</font>
								</form:label></td>
							<td><form:input path="productTag" id="txttelephone"
									class="text-box" placeholder="" /></td>
						</tr>
						<tr>
							<td><form:label class="label-Font" path="fileData">Image<font
										color="red">*</font>
								</form:label></td>
						...
						<tr>
							<td><form:label class="label-Font" path="category">Category</form:label></td>
							<td>	
							<form:select path="category" id="category" items="${listcategory}" itemValue="productCategoryId" itemLabel="categoryName"></form:select>
						...
						<tr>
							<td><form:label class="label-Font" path="description">Description<font
										color="red">*</font>
								</form:label></td>
							<td><form:textarea path="description" id="txtdesc"
									class="text-box" style="height:250px;"
									placeholder="My Needs And Enquiry " /></td>
						</tr>
